...
**TODO**: `stats.visual\_report.html` is currently generated by variantcalling. Move it to variantcomposition ? Make it for all VCF, not just DeepVariant ? (the plots look standard)
