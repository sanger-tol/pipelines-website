...
variant_analysis/pacbio/icLepMacu1/merged.1/calls/GCA_936432065.2.pacbio.icLepMacu1.merged.1.minimap2.deepvariant.vcf.gz
```
...
Here too, `${run}` may be one of the merged.`${#}` form.
