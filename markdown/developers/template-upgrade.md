...
1. Click on the "Run workflow" drop-down menu
   <img src="/assets/img/template-upgrade-dropdown-light.png" width="1041" class="hide-dark">
   <img src="/assets/img/template-upgrade-dropdown-dark.png" width="1041" class="hide-light">
2. Click on the "Run workflow" button
   <img src="/assets/img/template-upgrade-run-light.png" width="801" class="hide-dark">
   <img src="/assets/img/template-upgrade-run-dark.png" width="801" class="hide-light">
