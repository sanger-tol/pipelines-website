...
- When planning a new _major_ version due to pipeline features, consider renaming the input parameters
  and output files to avoid having to do another major version bump soon after.
- For other pipelines, plan a major version bump with all necessary changes, considering dependencies
